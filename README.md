...
- Export the playback itself: an animated SVG that loops the run on its own, or a video with sound (WebM, MP4 in Safari) for anywhere that won't animate an SVG.
